...
/** The old single-traveller/FX review form — still used for any request submitted before the Phase 0 rebuild (no memo_number). See review-card.tsx for the router that picks this vs. ReviewCardV2. */
export function ReviewCardLegacy({ row, fxRate }: { row: TravelRequestForHR; fxRate: number | null }) {
